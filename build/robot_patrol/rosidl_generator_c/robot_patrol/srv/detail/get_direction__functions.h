...
#ifndef ROBOT_PATROL__SRV__DETAIL__GET_DIRECTION__FUNCTIONS_H_
#define ROBOT_PATROL__SRV__DETAIL__GET_DIRECTION__FUNCTIONS_H_
 ...
 * calls
 * robot_patrol__srv__GetDirection_Request__init().
...
/**
 * It calls
 * robot_patrol__srv__GetDirection_Request__fini()
 ...
 * robot_patrol__srv__GetDirection_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * robot_patrol__srv__GetDirection_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * robot_patrol__srv__GetDirection_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robot_patrol
...
/**
 * It calls
 * robot_patrol__srv__GetDirection_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_robot_patrol
...
/**
 * It allocates the memory for the array and calls
 * robot_patrol__srv__GetDirection_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robot_patrol
...
/**
 * It calls
 * robot_patrol__srv__GetDirection_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ROBOT_PATROL__SRV__DETAIL__GET_DIRECTION__FUNCTIONS_H_
